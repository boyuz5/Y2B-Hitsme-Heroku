...
<div class="bg1" style="background: url(./thumbnail.php?type=banner&vid=<?php echo $channel['items'][0]['id'] ?>);background-repeat: no-repeat;background-position: center center;background-size: cover;" >
         ...
         <div class="container pt-2">
           ...
           <p class="kkkkkk pb-1 text-center" style="color: white;">
               <?php
               if(!empty($channel['items'][0]['snippet']['description'])){echo $channel['items'][0]['snippet']['description'];}else{echo 'This guy did not leave anything...';}?>
               </p>
          <script>
$(document).ready(function(){
 ...
 <div class="col-md-4 col-sm-12 col-xs-12 col-lg-4 equipodiv order-md-1 order-lg-1 order-xs-2 order-sm-2">
  <div class="related">
      <p class="font-weight-bold h6 pb-1">Channel information</p>
       ...
       <span class="d-block py-3 fa fa-user-circle-o"> <?php echo $channel['items'][0]['statistics']['subscriberCount']?> followers</span>
  ...
  <div class="related text-nowrap">
      <p class="font-weight-bold h6 pb-1">Featured channels</p>
       <?php
 ...
 <div class="col-md-8 col-sm-12 col-xs-12 col-lg-8 related order-md-2 order-lg-2 order-xs-1 order-sm-1">
    <div class="font-weight-bold h6 pb-1">All videos（<?php echo $channel['items'][0]['statistics']['videoCount'] ?>）</div> 
